...
func assumeRole(roleArn string, sessionName string, accesskey string, secretKey string, region string, externalId string)  *appmesh.AppMesh {
	...
	clusterClient := appmesh.New(awsSession)
